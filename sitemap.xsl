        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
                <div id="content">
                    <h1>XML Sitemap</h1>
                    <p class="desc">
                        This is a sitemap generated by <a href="http://vigour.io">Vigour</a> to allow search engines to discover this sites content.
                    </p>
                    ...
                    <xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
                        <p class="desc"><a href="http://www.mtvplay.tv/sitemap.xml" class="back-link">&#8592; Back to index</a></p>
                        <table id="sitemap" cellpadding="3">
                            <thead>
                                <tr>
